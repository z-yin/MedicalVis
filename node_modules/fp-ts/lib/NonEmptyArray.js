...
var NonEmptyArray = /** @class */ (function () {
    ...
    NonEmptyArray.prototype.filter = function (predicate) {
        var t = this.tail.filter(predicate);
        return predicate(this.head) ? Option_1.some(new NonEmptyArray(this.head, t)) : exports.fromArray(t);
    };
...
var foldr = function (fa, b, f) {
    return f(fa.head, fa.tail.reduceRight(function (acc, a) { return f(a, acc); }, b));
};
