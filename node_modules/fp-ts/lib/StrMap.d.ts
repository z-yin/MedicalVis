 ...
 * @since 1.0.0
 */
export declare const toUnfoldable: <F>(U: Unfoldable<F>) => <A>(d: StrMap<A>) => HKT<F, [string, A]>;
/**
 ...
 * @since 1.0.0
 */
export declare const strmap: Functor1<URI> & Foldable2v1<URI> & Traversable2v1<URI> & Compactable1<URI> & Filterable1<URI> & Witherable1<URI>;
